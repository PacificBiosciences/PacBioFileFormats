...
XML file representation. The 4.0.1 format is produced by the 9.0.0 release of PacBio
...
The SMRT Link CL tools in 9.0.0 provide command-line support for creating, filtering, validating,
